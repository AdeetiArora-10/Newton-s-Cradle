...
function setup() {
	...
	roofObject = new roof(500,300,200,20);
	...
	bobObject1 = new bob(500,1000,50,50);

	bobObject2 = new bob(500,1000,50,50);

	bobObject3 = new bob(500,1000,50,50);

	bobObject4 = new bob(500,1000,50,50);

	bobObject5 = new bob(500,1000,50,50);
	...
	rope3 = new rope(bobObject3.body, roofObject.body, 1, 0)
